...
namespace Drive_LFSS.Packet_
{
    ...
    public abstract class PacketHandler : Store
    {
        ...
        {
            ((Server)this).log.debug("NPL_PlayerJoinsRace(), NPL -> CName=" + _packet.carName + ", PName=" + _packet.driverName + ", PLID=" + _packet.carId + ", UCID=" + _packet.tempLicenceId + ", PType=" + _packet.driverTypeMask + "\r\n");
        }
