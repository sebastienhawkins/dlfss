...
(6, 'message bar top', 2, 0, 0, 60, 10, 80, 12, '^1Message bar top'), 
(7, 'message bar middle', 2, 0, 0, 25, 85, 150, 14, '^1Message bar Middle'), 
(8, 'Collision Warning', 2, 0, 0, 25, 70, 150, 14, '^1CollisionWarning'), 
...
insert  into race_template (entry,description,track_entry,car_entry_allowed,weather,wind,lap_count,qualify_minute,grid_start_beviator,mask) values 
