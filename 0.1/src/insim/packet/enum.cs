...
namespace Drive_LFSS.Packet_
{
    ...
    public enum Tiny_Type : byte
    {
        ...
        TINY_SST_STATE_INFO,		//  7 - info request	: send state info
        ...
        TINY_REO_GRID_ORDER,		                        // 18 - info request	: send an IS_REO
        TINY_RST_RACE_START,		                        // 19 - info request	: send an IS_RST
